...
$birthdayDate = intval(date("d",strtotime($residentRecord->birthday)));
$birthdayMonth = intval(date("m",strtotime($residentRecord->birthday)));
$birthdayYear = intval(date("Y",strtotime($residentRecord->birthday)));

$residentRecord->birthdayDate = $birthdayDate;
$residentRecord->birthdayMonth = $birthdayMonth;
$residentRecord->birthdayYear = $birthdayYear;

$residentSinceDate = intval(date("d",strtotime($residentRecord->resident_since)));
$residentSinceMonth = intval(date("m",strtotime($residentRecord->resident_since)));
$residentSinceYear = intval(date("Y",strtotime($residentRecord->resident_since)));

$residentRecord->residentSinceDate = $residentSinceDate;
$residentRecord->residentSinceMonth = $residentSinceMonth;
$residentRecord->residentSinceYear = $residentSinceYear;
 ...
 -->
		...
		<div>
			...
			<div style="text-align:left" class="span6">
				...
				<br>
				<?php echo CHtml::activeTextField($residentRecord, 'residentSinceYear', array('placeholder'=>"Year",'value'=>$residentSinceYear)); ?>
