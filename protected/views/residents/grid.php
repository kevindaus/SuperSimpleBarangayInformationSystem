...
<div class="pull-left">
	<div class="btn-group">
		<?php echo CHtml::link("<span class='icon-th'></span>", array('grid'), array('class'=>'btn btn-default active')); ?>
		<?php echo CHtml::link("<span class='icon-list'></span>", array('list'), array('class'=>'btn btn-default')); ?>
	</div>
