...
var XPhoto = XPhotoClass({
    ...
    createButtons: function(){
    	var buttons = '';
    	if(this.options.capture===true){
    		buttons += '<button type="button" class="btn btn-success xphoto-button-camera"><i class="fa fa-camera"></i>Webcam</button>'
					  +'<button type="button" class="btn btn-primary xphoto-button-snap" style="display:none;"><i class="fa fa-circle"></i></button>';
		}
		if(this.options.upload===true){
			buttons += '<button type="button" class="btn btn-default xphoto-button-upload"><i class="fa fa-upload"></i> Upload</button>';
		}
					  ...
					  +'<div class="modal-dialog">'
					    +'<div class="modal-content">'
					      +'<div class="modal-header">'
					        ...
					        +'<h4 class="modal-title">Capture webcam</h4>'
					      +'</div>'
    ...
    error: function(error) {
    	if(error === 'NO_DEVICES_FOUND'){
    		error = 'You dont have a webcam attached';
    	}
